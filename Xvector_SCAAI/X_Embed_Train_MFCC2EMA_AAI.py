...
OutFileName='Xvec_Embd_AAI_'+'Batch'+ str(BatchSize)+'_'+'seenVal'+'_LSTMunits_'+str(NoUnits)+'_'
fName=OutFileName
print('..fitting model')
...
scipy.io.savemat(OutDir+fName+'_SeenSub_Results.mat',{'RMSE':TSrmse,'Corr':TSCC})
